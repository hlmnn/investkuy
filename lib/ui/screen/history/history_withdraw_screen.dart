...
class HistoryWithdraw extends StatefulWidget {
  const HistoryWithdraw({super.key, required this.title, required this.walletId});
...
class _HistoryWithdrawState extends State<HistoryWithdraw> {
  Future refresh() async {
    BlocProvider.of<CreditHistoryCubit>(context).getCredits(widget.walletId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: BlocBuilder<CreditHistoryCubit, DataState>(
          builder: (context, state) {
            List<CreditTransactionModel> items = [];
