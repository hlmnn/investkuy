...
class _UmkmLaporanKeuanganState extends State<UmkmLaporanKeuangan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ListLaporanCubit, DataState>(builder: (context, state) {
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title:
                                    Text('Laporan Keuangan ke - ${index + 1}'),
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => VisitorPdfScreen(
                                          url: pdfFile.laporanUrl),
                                    ),
                                  );
                                },
                              );
      ...
      bottomNavigationBar: BottomAppBar(
        child: Container(
          ...
          child: BlocBuilder<AddLaporanCubit, DataState>(
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (state is SuccessState) {
                          if (state.data is bool) {
                            textEditingFilePickerController.clear();
