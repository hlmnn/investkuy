...
class _RiwayatInProgressState extends State<RiwayatInProgress> {
  Future refresh() async {
    BlocProvider.of<InvestorRiwayatInProgressCubit>(context)
        .getAllInProgressPendanaan();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<InvestorRiwayatInProgressCubit, DataState>(
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          ": ${CurrencyFormat.convertToIdr(item.repayment, 0)}",
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                          ),
                                        ),
