...
import 'package:investkuy/ui/screen/investor/investor_detail_investing_screen.dart';
import 'package:investkuy/ui/screen/investor/investor_detail_screen.dart';

class InvestorUmkm extends StatefulWidget {
  const InvestorUmkm({super.key, required this.title});

  final String title;

  @override
  _InvestorUmkmState createState() => _InvestorUmkmState();
}

class _InvestorUmkmState extends State<InvestorUmkm> {
